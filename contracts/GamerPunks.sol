...
interface IGamerPunks is IERC721Enumerable {
    function isMintedBeforeReveal(uint256 index) external view returns (bool);
}

contract GamerPunks is IGamerPunks, ERC721, Ownable {
    using SafeMath for uint256;

    string public constant GAMERPUNKS_PROVENANCE = "df760c771ad006eace0d705383b74158967e78c6e980b35f670249b5822c42e1";

    uint256 public constant SALE_START_TIMESTAMP = 1629380700; // 3 September

    // Time after which GamerPunks are randomized and allotted 3 September + 14 days
    ...
    // Mapping from token ID to whether the GamerPunk was minted before reveal
    ...
    /**
     * @dev Gets current GamerPunk Price
     */
    ...
    */
    ...
    /**
     * @dev Changes the name for GamerPunk tokenId
     */
